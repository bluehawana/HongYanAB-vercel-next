      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">Hong Yan AB</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-300">Cloud Architecture</li>
              <li className="text-gray-300">Enterprise Consulting</li>
              <li className="text-gray-300">Database Solutions</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-600 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-300">
              © {new Date().getFullYear()} Hong Yan AB. All rights reserved.
            </p>
