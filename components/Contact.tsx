            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4 p-4 bg-white rounded-lg shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Gothenburg, Sweden</p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary text-gray-900 bg-white"
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary resize-none text-gray-900 bg-white"
